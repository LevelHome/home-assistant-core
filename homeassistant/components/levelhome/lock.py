...
class LevelLockEntity(CoordinatorEntity[LevelLocksCoordinator], LockEntity):
    ...
    def _handle_coordinator_update(self) -> None:
        ...
        if current_state and self._previous_state:
            previous_lower = self._previous_state.lower()
            current_lower = current_state.lower()
            device_name = self._device.name
            if previous_lower == "locking" and current_lower == "locked":
                logbook.async_log_entry(
                    self.hass,
                    name=device_name,
            ...
            elif previous_lower == "unlocking" and current_lower == "unlocked":
                logbook.async_log_entry(
                    self.hass,
                    name=device_name,
